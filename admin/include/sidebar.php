...
<!--             <li><a class="treeview-item" href="widgets.html"><i class="icon fa fa-circle-o"></i> Manage Category</a></li>
 ...
 <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Booking History</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li class="treeview"><a class="app-menu__item" href="member.php" ><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Member</span></a>
        </li>
        <li class="treeview"><a class="app-menu__item" href="supplements.php" ><i class="app-menu__icon fa fa-clipboard"></i><span class="app-menu__label">Supplement</span></a>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Diet</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="veg-diet.php"><i class="icon fa fa-circle-o"></i>Veg Food</a></li>
            <li><a class="treeview-item" href="non-veg-diet.php"><i class="icon fa fa-circle-o"></i>Non-veg Food</a></li>
          </ul>
        </li>
      </ul>
    </aside>
